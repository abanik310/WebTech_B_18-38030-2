...
a:hover, a:active {
  ...
  div,ul,li.overflow{overflow-x: scroll;}
...
<body class="w3-light-grey" onbeforeprint="printMsg()">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="form">
        ...
        <tbody>
            <?php if (isset($admins)) foreach ($admins as $i => $admin) : ?>
                <tr >
                    ...
                    <td><img src="<?php echo $data['images']; ?>" width="100" height="100" onerror="imgError()"></td>
                    <td><a href="editAdmin.php?o-id=<?php echo $admin['o-id'] ?>">Edit</a>&nbsp<a href="../controller/deleteAdmin.php?o-id=<?php echo $admin['o-id'] ?>" onclick ="alert('Admin Delete Permanently')">Delete</a></td>
  ...
  </div></center></form> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
  <button style="position: right" onclick="window.print()">Print this page</button>
