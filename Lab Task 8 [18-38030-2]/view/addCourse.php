<?php include_once "../controller/createCourse.php" ?>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar"><br>
      ...
      <h5 class="Dashboard">Add Course</h5>
    </div>
  </div>
  <hr>
    ...
    <ul class="w3-ul w3-card-4 w3-white">
      <li class="w3-padding-16">
        ...
        <center>
        	...
        	Course Name &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&emsp; &nbsp;&nbsp;&nbsp; &emsp;&emsp;<sup style="color: red;">*</sup> <input type="text" name="name"> <span style="color:orangered"><?php echo $nameErr; ?><br><br></span>

        
        	Course Id &emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp; &emsp; &nbsp; &emsp;&emsp;<sup style="color: red;">*</sup> <input type="text" name="c-id"> <span style="color:orangered"><?php echo $cidErr; ?><br><br></span>

               
            Assigned Teacher (id) &nbsp; &nbsp;&nbsp;&nbsp; &emsp; &emsp;&emsp;<input type="text" name="t-id"> <span style="color:orangered"> <?php echo $tidErr; ?><br><br></span>
