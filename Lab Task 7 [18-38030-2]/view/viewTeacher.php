...
<body>
    ...
    <table id="teachers">
        ...
        <tbody>
            ...
            <td><?php echo $teacher['o-id'] ?></td>
            <td><?php echo $teacher['dob'] ?></td>
            <td><?php echo $teacher['gender'] ?></td>
            <td><a href="editTeacher.php?o-id=<?php echo $teacher['o-id'] ?>">Edit</a>&nbsp<a href="controller/deleteTeacher.php?id=<?php echo $teacher['o-id'] ?>">Delete</a></td>
            </tr>
        </tbody>
    </table>
</body>
