  ...
  <div class="w3-container">
    ...
    <ul class="w3-ul w3-card-4 w3-white">
      <li class="w3-padding-16">
        <img src="https://cn.i.cdn.ti-platform.com/cnapac/content/2016/showpage/ben-10/in/showicon.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
        <span class="w3-xlarge">Mridul</span>
        <i word-spacing: 5px;class="recentUser">39 mins</i><br>
      </li>
      <li class="w3-padding-16">
        <img src="https://cn.i.cdn.ti-platform.com/cnapac/content/336/showpage/the-amazing-world-of-gumball/sa/showicon.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
        <span class="w3-xlarge">Afridi</span><br>
      </li>
      <li class="w3-padding-16">
        <img src="https://i.pinimg.com/originals/3c/9e/9c/3c9e9cdc563f8e91922e8c946bb96541.jpg" class="w3-left w3-circle w3-margin-right" style="width:35px">
        <span class="w3-xlarge">Tutul</span><br>
      </li>
    </ul>
  </div>
  <hr>
