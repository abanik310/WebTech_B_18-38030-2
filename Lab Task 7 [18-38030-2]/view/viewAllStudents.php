<?php include_once "../controller/viewStudent.php";
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar"><br>
      ...
      <h5 class="Dashboard">View All Student</h5>
    </div>
  </div>
  <hr>
        ...
        <tbody>
            <?php if (isset($students)) foreach ($students as $i => $student) : ?>
                <tr>
                    ...
                    <td><a href="editStudent.php?o-id=<?php echo $student['o-id'] ?>">Edit</a>&nbsp<a href="../controller/deleteStudent.php?o-id=<?php echo $student['o-id'] ?>">Delete</a></td>
                </tr>
            <?php endforeach; ?>
